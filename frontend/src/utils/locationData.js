...
export const LOCATION_DATA = {
  ...
  haiphong: {
    ...
    districts: {
      ...
      "Lê Chân":     ["An Biên","Vĩnh Niệm","An Dương","Cát Dài","Dư Hàng","Dư Hàng Kênh","Đông Hải","Hàng Kênh","Kênh Dương","Lam Sơn","Nghĩa Xá","Niệm Nghĩa","Trần Nguyên Hãn","Vĩnh Niệm"],
      ...
      "Đồ Sơn":      ["Bàng La","Hòa Đồng","Minh Đức","Ngọc Hải","Vạn Hương","Vạn Sơn","Ngọc Xuyên"],
